<?php
  ...
  $message = 'Dear ' . $data["name"] . ',' . "\r\n\r\n" . 'Your appointment with '
    . $data["medicName"] . ' has been updated. Here is the resume:' . "\r\n" . '- Symptoms and Risk Factors: ' 
    . $symptomsAndRisks . "\r\n" . '- Prescription: ' . $data["prescription"] . "\r\n\r\n" 
    . 'If you want to learn more about this appointment, log into our website at http://localhost/covidsym/userLogin/ and check the doctor\'s notes.'
    . "\r\n\r\n" . 'This message was automatically generated by COVIDSYM and should not be answered.';
  echo $message;
  mail($data["email"], $data["date"] . '\'s Appointment Results', $message);
